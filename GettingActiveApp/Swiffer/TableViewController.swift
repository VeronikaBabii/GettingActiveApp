...
//
//            if let name = composeAlert.textFields?.first?.text, let hashtags = composeAlert.textFields?.last?.text {
//
//                let newSweet = Sweet(name: name, hashtags: hashtags, timeStamp: String())
//
...
//
//        cell.textLabel?.text = "\(sweet.name): \(sweet.hashtags)"

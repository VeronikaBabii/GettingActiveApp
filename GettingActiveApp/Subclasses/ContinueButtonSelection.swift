...
//import UIKit
//
//class ContinueButtonSelection: UIButton {
//
//    var isOn = false
//
...
//
//        addTarget(self, action: #selector(ContinueButtonSelection.buttonPressed), for: .touchUpInside)
//    }
//
